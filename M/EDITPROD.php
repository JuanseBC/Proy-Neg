...
<body>
  ...
  <form id="form" method="post" action="../C/actProd.php">
    <div class="form">
      ...
      <div class="grupo">
        <input type="text" name="codProd" id="name" value="<?php echo $result['idprod'] ?>" required><span
          class="barra"></span>
        <label for="">Codigo del producto</label>
      </div>
      <div class="grupo">
        <input type="text" name="nomProd" id="name" value="<?php echo $result['nomprod'] ?>" required><span
          class="barra"></span>
        <label for="">Nombre del producto</label>
      </div>
      <div class="grupo">
        <input type="number" name="stock" id="name" value="<?php echo $result['stock'] ?>" required><span
          class="barra"></span>
        <label for="">Stock</label>
      </div>
      <div class="grupo">
        <input type="number" name="Val" id="name" value="<?php echo $result['valprod'] ?>" required><span
          class="barra"></span>
